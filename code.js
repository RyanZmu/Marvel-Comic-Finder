...
class SuperHero {
  ...
  createCard (heroName) {
    ...
    const fetchUrl = `https://gateway.marvel.com/v1/public/characters?nameStartsWith=${heroName}&apikey=cecb0667f3786d500e442a8d4990b71e&hash=8152e0c81bfdf8b93856bf07eca79912&ts=1`
  ...
  buildHeroCard () {
    ...
    nextPicture.addEventListener('click', () => {
      const imagesAvailable = this.thumbnail.length
  ...
  comicClick (comics) {
    comics.data.results.map(comic => {
      ...
      const comicLink = document.createElement('a') // link to purchasing the comic
